        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Team Info</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Player Number</h4>
                                <div class="card-content">
                                         <img src="img/favicon.png" class="img-circle img-responsive">
                                </div>
                            </div>                    
                <hr>
             
                 Member Name | Position(big man)
                        </div>
                        <!-- /# card -->
                    </div>
